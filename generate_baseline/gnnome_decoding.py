...
from misc.utils import asm_metrics, timedelta_to_str, yak_metrics, t2t_metrics
...
def gnnome_decoding(genome, gnnome_config, paths, motif):
    ...
    t2t_metrics(paths['baseline'], paths['t2t_chr'], paths['ref'], motif)
